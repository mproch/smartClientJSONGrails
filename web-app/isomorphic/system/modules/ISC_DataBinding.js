...
_2[_3]=_4}
return _2}
,isc.A.checkEmptyCriteria=function isc_c_DataSource_checkEmptyCriteria(_1){if(_1.criteria){if(_1.criteria.length==0)return null;for(var i=_1.criteria.length;i>=0;i--){var _3=_1.criteria[i],_4=false;if(!_3)_4=true;else{if(!_3.criteria){if(isc.isA.emptyObject(_3))_4=true}else{var _5=this.checkEmptyCriteria(_3);if(_5)_1.criteria[i]=_5;else _4=true}}
if(_4)_1.criteria.removeAt(i)}}
if(_1.criteria&&_1.criteria.length==0)return null;return _1}
...
var _9=this.getDataURL(_1);_9=_1.actionURL||_1.dataURL||_9;if(_1.useHttpProxy==null){_1.useHttpProxy=this.$du(_2.useHttpProxy,this.useHttpProxy)}
...
if(isc.getValues(_3).length>0){_1.data=isc.DataSource.combineCriteria(_1.data,_3,"and",null,true)}}}
...
);isc.evalBoundary;isc.B.push(isc.A.$52v=function isc_DataSource__parseNumber(_1,_2){if(_1==null)return _2;if(!isc.isA.String(_1))return _1;var _3=parseInt(_1);if(isNaN(_3))return _2!=null?_2:_1;else return _3}
...
_1.data=_4}
var _4=this.transformRequest(_1);var _5=this.getDataProtocol(_1);if(_5=="clientCustom")return;if((!this.clientOnly&&!this.cacheAllData)||(_1.cachingAllData||(this.cacheAllData&&_1.operationType&&_1.operationType!="fetch")))
...
if(_8)_6.add(_7)}
return _6}
);isc.evalBoundary;isc.B.push(isc.A.recordMatchesFilter=function isc_DataSource_recordMatchesFilter(_1,_2,_3){if(this.isAdvancedCriteria(_2)){return this.recordsMatchingAdvancedFilter([_1],_2,_3).length>0}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+159;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{if(_6!=null&&_6!=isc.emptyString){return null}}}
...
,isc.A.$53x=function isc_Canvas__fireFetchCallback(_1,_2,_3){var _4=_3.clientContext?_3.clientContext.$53w:null;if(_4){this.fireCallback(_4,"dsResponse,data,dsRequest",arguments);delete _3.clientContext.$53w}}
