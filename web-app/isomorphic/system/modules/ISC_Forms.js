...
,isc.A.valuesHaveChanged=function isc_DynamicForm_valuesHaveChanged(_1){var _2=this.getValues(),_3=this.$10s,_4=false,_5={};if(!isc.isAn.Object(_3))_3={};var _6="__ref";for(var _7 in _2){if(isc.isA.Function(_2[_7]))continue;if(_7==_6)continue;var _8=this.getItem(_7);if(_8!=null){_4=!_8.compareValues(_2[_7],_3[_7])}else{_4=!isc.DynamicForm.compareValues(_2[_7],_3[_7])}
if(_4){if(!_1)return true;_5[_7]=_2[_7]}}
return(_1?_5:_4)}
...
var _5=this.$76u?isc.clone(this.$76u):{operator:this.operator,_constructor:"AdvancedCriteria",criteria:[]};var _6=this.$76v(true,_2);_5.criteria.addList(_6);return isc.DS.checkEmptyCriteria(_5)||{}}
...
if(isc.Browser.isMoz)_13[6]=(_14<0?"ignore;":"normal;");_13[7]=_3?"cursor:default;":null;_13[9]=_14;_13[13]=_11;_13[17]=_12;_13[19]=this.$157(this.$16n(_12),_6,_7,this.$16l(_1),this.$16m(_1),(!_15?_8:null),_9,_5,_11,_12,_8);return _13.join(isc.emptyString)}}
...
var _4=isc.addProperties({},this.optionFilterContext,{showPrompt:false,clientContext:{dataValue:_1},componentId:this.containerWidget.getID(),componentContext:this.getFieldName()});var _5;if(this.optionOperationId!==_5){_4.operationId=this.optionOperationId}
...
,isc.A.handleEditorExit=function isc_FormItem_handleEditorExit(){if(!this.$178)return;this.$178=null;var _1=this.getValue();if(this.validateOnExit||this.form.validateOnExit){if(this.form.isNewRecord()||!this.compareValues(_1,this.$75h))
{this.validate()}
this.$75h=null}
...
);isc.evalBoundary;isc.B.push(isc.A.$43g=function isc_FormItem__handleInput(){isc.EH.$h1("INP");if(this.changeOnKeypress&&!this.mask){if(isc.Log.supportsOnError){this.updateValue()}else{try{this.updateValue()}catch(e){isc.Log.$am(e)}}}
isc.EH.$h2()}
...
var _2={_redrawWithParent:false,$so:true,tabIndex:-1,canvasItem:this,disabled:this.isDisabled()};_2.resized=this.$18v;_2.dragResized=this.$18w;_2.$kf=this.$18x;if(this.dataSource)_2.dataSource=this.dataSource;if(this.prompt)_2.prompt=this.prompt;if(this.accessKey!=null)_2.accessKey=this.accessKey;if(this.showFocused!=null)_2.showFocused=this.showFocused;if(this.showFocusedAsOver!=null)_2.showFocusedAsOver=this.showFocusedAsOver;if(isc.isA.String(this.canvas)&&window[this.canvas])this.canvas=window[this.canvas];if(!isc.isA.Canvas(this.canvas)){isc.addProperties(_2,this.canvas);if(_2.ID==null)_2.ID=null;this.autoDestroy=true;this.addAutoChild("canvas",_2,isc.Canvas,this.containerWidget)}else{this.canvas.setTabIndex(-1);this.canvas.setPrompt(this.prompt);this.canvas.setAccessKey(this.accessKey);isc.addProperties(this.canvas,_2);if(_2.dataSource)this.canvas.bindToDataSource();this.canvas.setDisabled(this.isDisabled());this.containerWidget.addChild(this.canvas)}}
...
return _3}
,isc.A.multiSelectChanged=function isc_PickListMenu_multiSelectChanged(){var _1=this.formItem,_2=_1.getValueFieldName(),_3=this.getSelection(),_4=[];for(var i=0;i<_3.length;i++){var _6=_3[i];_4.add(_6[_2])}
_1.pickValue(_4)}
...
,isc.A.$10y=function isc_ComboBoxItem__updateValue(_1,_2){var _3=this.getElementValue(),_4=(_1==_3&&this.mapValueToDisplay(this.getValue())==_3);this.$80p=(!_4&&!this.$201);if(this.addUnknownValues||_2){return this.Super("$10y",arguments)}
if(_4)return;var _5=this.mapValueToDisplay(_1);if(_5==_1){this.saveValue(null);this.refreshPickList(_1);return}
...
,isc.A.setValue=function isc_ComboBoxItem_setValue(_1,_2,_3,_4,_5){this.$80p=false;this.$43o=true;this.invokeSuper(isc.ComboBoxItem,"setValue",_1,_2,_3,_4,_5);delete this.$43o;if(!this.hasFocus&&this.showHint&&this.showHintInField&&this.getHint()){var _6;if(_1===_6||_1==null||isc.is.emptyString(_1)){this.$66t()}}}
...
return _1}
,isc.A.getCriteriaFieldName=function isc_ComboBoxItem_getCriteriaFieldName(){var _1=this.$80p&&!this.getSelectedRecord();if(this.displayField&&_1)return this.displayField;return this.criteriaField||this.getFieldName()}
...
,isc.A.getChangedValues=function isc_ValuesManager_getChangedValues(){var _1=this.getValues(),_2=this.$10s,_3=false,_4={};if(!isc.isAn.Object(_2))_2={};for(var _5 in _1){if(isc.isA.Function(_1[_5]))continue;var _6=this.getItem(_5);if(_6!=null){_3=!_6.compareValues(_1[_5],_2[_5])}else{_3=!isc.DynamicForm.compareValues(_1[_5],_2[_5])}
if(_3){_4[_5]=_1[_5]}}
return _4}
