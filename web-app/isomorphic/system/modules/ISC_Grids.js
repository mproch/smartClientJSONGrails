 ...
 * Version SC_SNAPSHOT-2010-12-26 (2010-12-26)
...
if(this.isPrinting){if(_1==null)_1=0;if(_2==null)_2=this.fields?this.fields.getLength()-1:0;return"<TABLE cellspacing=0 style='width:100%' class='"+this.emptyMessageTableStyle+"'>"+this.grid.getPrintHeaders(_1,_2)+"<TR><TD  ALIGN=CENTER VALIGN=TOP class='"+(_3?this.offlineMessageStyle:this.emptyMessageStyle)
"' colspan='"+((_2-_1)+1)+"'>"+(_3?this.getOfflineMessage():this.getEmptyMessage())+"</TD></TR></TABLE>"}
...
var _80=_77?this.$67p(_76,_74,_26,_27):null;for(var i=0;i<_28.length;i++){_1=_28[i];var _81=_32[_1],_82=_76;if(_82==null)_82=this.getCellRecord(_74,_1);if(_71[_1]>0){_81.$28w[_74]=_73[_1];_71[_1]--;if(_71[_1]==0){_72--;_73[_1]=null}
continue}
_53[_56]=this.getCellAlign(_76,_81,_74,_1);var _83=this.getCellVAlign(_76,_81,_74,_1);if(_83!=null){_53[_57]=_70
_53[_58]=_83}
if(_80!=null&&(_1==_80[0])){_51++;_53[_59]=this.$67q(_80[1]-_80[0]);if(_52){_53[_64+1]=this.$ob}}else{_53[_59]=_81.$28x;if(this.getRowSpan){var _84=this.getRowSpan(_76,_74,_1);if(_84>1){var _85=" ROWSPAN="+_84;if(_53[_56]!=null)
_53[_56]+=_85;else
_53[_56]=_85;_71[_1]=_84-1;_72++;_73[_1]=_74;if(_81.$28w==null)_81.$28w={};_81.$28w[_74]=_74}}
if(_52){_53[_64+1]=_81.$28y}else{_53[_64+1]=null}}
var _86=this.getCellStyle(_76,_74,_1),_87=(this.getCellCSSText?this.getCellCSSText(_76,_74,_1):null);if(_75){var _88="padding:0px;border:0px;";if(_87)_87+=";"+_88
else _87=_88}
if(!this.fastCellUpdates){_53[_61]=_87
_53[_62]=_86}else{var _89=this.$77d(_86);_53[_61]=_89;_53[_61+1]=_87}
if(_75){this.$28q=true;var _90=this.getTableHTML(null,this.$28c,this.$28e);delete this.$28q;if(!_52){_53[_65]=isc.SB.concat(this.$27s,this.$283(_78,_76,_74,_75),this.$ob,this.$oa,_90,"</DIV>")}else{_53[_65]=_90}}else
_53[_65]=this.$22k(_76,_74,_1);if(!_13&&this.getCellElementId){_53[_63]=this.getCellElementId(_74,_74-_2,_1,_1-_26)}
_31.append(_53);if(!_13&&_82!=null&&_82.$29a!=null){if(_82.$29a[0]&&_82.$29a[0].rowNum==null)
{this.updateEmbeddedComponentCoords(_82.$29a,_82,_74,_1)}}
if(_77&&(_1==_80[0])){i+=_80[1]-_80[0]}}
_31.append(_67);if(this.isPrinting&&_76.$29a!=null){var _91=_76.$29a;for(var _92=0;_92<_91.length;_92++){var _93=_91[_92];if(_93.$57n==null&&_93.$80t!=null){_31.append(_66,_68,'<td colspan="',_29,'">',_93.$80t,"</td>",_67);delete _93.$80t}}}
if(_75){_74=this.$28e-1}}}
if(!this.$568||_3==this.getTotalRows())_31.append("</TABLE>");var _94=_15-_3,_95=(!_13&&this.$60s);var _96=this.cacheDOM?0:(this.endSpace||0);this.$515=0;if(!this.showAllRows&&(_94!=0||_95)){var _97=_94*this.getAvgRowHeight();if(_95&&_94==0){var _98=this.getViewportHeight();if(_97<_98){_97=_98}}
this.$515=_97;_96+=this.$515}
if(!this.cacheDOM&&!this.isPrinting){_31.append("<DIV style='width:1px;");if(_43){_31.append("height:",_96,"px;overflow:hidden;")}
if(_96==0)_31.append("display:none;");_31.append("' ");if(_13||this.isPrinting){_31.append(">")}else{_31.append(" ID="+this.getID()+"$284>")}
_31.append(isc.Canvas.spacerHTML(1,_96),"</DIV>")}
if(this.logIsDebugEnabled("gridHTML")){var _99=(isc.timeStamp()-_7),_100=(_29*(_3-_2)),_101=(_99/ _100),_102=(1000/_101);if(_101.toFixed!=null)_101=_101.toFixed(2);if(_102.toFixed!=null)_102=_102.toFixed(2);this.logDebug("getTableHTML: columns "+(_4?_28:_26+"->"+(_27-1))+", rows "+_2+"->"+(_3-1)+", time: "+_99+"ms ("+_100+" cells at "+_101+"ms per cell, "+_102+" cells per second), "+"spacerHeights: ["+[_41,_96]+"], "+"left/right pad: ["+[_34,_35]+"], "+_51+" single cell rows","gridHTML")}
var _103=_31.release();if(_6){if(_5!=null){this.fireCallback(_5,"HTML,callback",[_103,_5])}
return null}
return _103}
...
,isc.A.modifyContent=function isc_GridRenderer_modifyContent(){if(!this.$28c)this.$29d();if(this.$27y!=null){this.$80f=true;this.$270();this.$80f=null;var _1=this.getTableElement();if(_1)_1.style.visibility="inherit"}
...
var _15=this.getDrawArea();var _16=this.grid,_17=this.$74k;if(!_17)_17=this.$74k=[0,0,0,0];var _16=this.grid,_18=_16.getRecord(_15[0]),_19=_16.getRecord(_15[1]),_20=(_18&&_18!=Array.LOADING)&&(_19&&_19!=Array.LOADING);;if(_20&&!_17.equals(_15))
{if(!this.frozen){_16.$74l(_17[0],_17[1],_17[2],_17[3],this);this.$74k=_15}}
if(!(this.frozen&&(_1==this.$81l||_1=="scrolled"))){_16.updateRecordComponents()}
...
if(_10){if(!_16||isc.isAn.emptyString(_16))_16=this.emptyCellValue;_6=_16}else{_6=this.$315(_6,_1,_5,_2,_3);var _17=this.getFieldHilites(_1,_5);if(_17)_6=this.applyHiliteHTML(_17,_6);if(_16){if(_5.valueIconOrientation!=isc.Canvas.RIGHT)
_6=_16+_6;else
_6=_6+_16}}
...
delete _3.$316}
);isc.evalBoundary;isc.B.push(isc.A.$69l=function isc_ListGrid__clearingInactiveEditorHTML(_1,_2){if(!this.$286||!this.$686((_2!=null?this.getField(_2):null),true))return;if(_1!=null){var _3="_"+_1+"_"+_2,_4=this.$69m[_3];if(_4){_4.formItem.clearInactiveEditorContext(_4);delete this.$69m[_3]}}else{var _5=this.getEditForm(),_6=_5.getItems();for(var i=0;i<_6.length;i++){_6[i].clearAllInactiveEditorContexts()}
delete this.$69m}}
...
if((_2.$26a==null||(_2.$26a.length==0&&_2.fields.length>0))||(_3&&(_3.$26a==null||(_3.$26a.length==0&&_3.fields.length>0))))return;this.$81r=true;var _4=this.$81s||[],_5=this.$81t||{};this.$81t={};this.$81s=[];if(this.showRecordComponents||this.showBackgroundComponents){var _6=this.body.getDrawArea(),_7=this.showRecordComponentsByCell,_8=this.body.getID(),_9=this.frozenBody?this.frozenBody.getID():null;if(_1){this.logDebug("updating to potentially show recordComponents for drawArea:"+_6,"recordComponents")}
...
,isc.A.recalculateSummaries=function isc_ListGrid_recalculateSummaries(){if(this.showGridSummary&&this.summaryRow!=null){this.summaryRow.recalculateSummaries()}
...
if(this.editByCell){var _9=(this.frozenFields!=null)||(this.baseStyle==null);if(_9)this.refreshRow(_1);else this.refreshCell(_1,_2)}else{var _10=this.getDrawnFields();for(var i=0;i<_10.length;i++){if(this.isCheckboxField(_10[i]))continue;var _12=_10[i][this.fieldIdProperty],_13=this.$286.getItem(_12),_2=_13.colNum,_14=!!(_4&&_13.isDrawn()),_15=this.canEditCell(_1,_2);if(_14!=_15)this.refreshCell(_1,_2);else if(this.selectOnEdit||this.lastOverRow){var _8=this.getField(_12).frozen?this.frozenBody:this.body;_8.$29h(this.getCellRecord(_1,_2),_1,_2)}}}}
...
);isc.evalBoundary;isc.B.push(isc.A.$45p=function isc_ListGrid__editorGetAutoComplete(){var _1=this.grid;if(!_1)return null;var _2=_1.getField(this.getFieldName());if(_2.autoComplete!=null)return _2.autoComplete;if(_1.autoComplete!=null)return _1.autoComplete;return this.Super("$17h",arguments)}
...
);isc.evalBoundary;isc.B.push(isc.A.saveAndEditPreviousCell=function isc_ListGrid_saveAndEditPreviousCell(){this.$33z(-1,true)}
...
var _11=this.recordHasChanges(_3,_4,false);if(this.$32k()){this.$81c=(_5||_11);var _12;if(this.useCellRecords){_12=!this.validateCell(_3,_4)}else{_12=!this.validateRow(_3)}
if(_12){if(!_5)this.$331(_10,_2);return false}}
if(_5)return true;if(!_11){this.logInfo("saveEdits: no actual change, not saving","gridEdit");this.$321(_8,_4);this.$332(_2,_3,_4,_1,true);return}
_6=this.$300(_3,_4);this.logInfo("Saving newValues '"+isc.echoAll(_6)+"'","gridEdit");this.rememberSubmittedEditValues(_3,_4);_6=isc.addProperties({},_6);var _13=this.saveEditedValues(_3,_4,_6,_9,_8,_1,_2);if(_13===false){this.$331(_10,_2);return false}
return true}
...
if(_1.$81f||isc.isAn.Object(_1))return _1;if(isc.isA.String(_1))return this.fields.find(this.fieldIdProperty,_1);return null}
...
);isc.evalBoundary;isc.B.push(isc.A.getEventRecordNum=function isc_ListGrid_getEventRecordNum(_1){return this.getEventRow(_1)}
...
if(this.summaryRow&&this.showGridSummary){this.summaryRow.setFields(this.completeFields.duplicate());this.summaryRow.rebuildForFreeze(_1);this.summaryRow.recalculateSummaries()}}
...
,isc.A.getLocalFieldNum=function isc_ListGrid_getLocalFieldNum(_1){if(!this.frozenFields)return _1;var _2;_2=this.frozenFields.length;if(!this.fieldIsFrozen(_1))return _1-_2;return this.freezeLeft()?_1:_1-(this.fields.length-this.frozenFields.length)}
...
,isc.A.toggleFrozen=function isc_ListGrid_toggleFrozen(_1,_2){var _1=this.getField(_1);if(!_1||!this.fieldIsVisible(_1)||this.isCheckboxField(_1))return false;if(_1.frozen==_2)return false;_1.frozen=_2;this.rebuildForFreeze();return true}
...
);isc.evalBoundary;isc.B.push(isc.A.sorterContextClick=function isc_ListGrid_sorterContextClick(){var _1=this.showHeaderContextMenu;if(this.showCornerContextMenu!=null)_1=this.showCornerContextMenu;if(_1)return this.displayHeaderContextMenu(this.sorter)}
...
if(_2.length==0||_2[0]==null){this.logInfo("ungrouping","grouping");this.isGrouped=false;if(this.originalData){var _4=this.preserveEditsOnSetData;this.preserveEditsOnSetData=true;this.setData(this.originalData);this.preserveEditsOnSetData=_4;delete this.originalData;if(this.groupTree&&this.groupTree.criteria){this.data.setCriteria(this.groupTree.criteria)}
...
_1.addMethods(_2)}
);isc.evalBoundary;isc.B.push(isc.A.addProperties=function isc_ListGrid_addProperties(_1){this.Super("addProperties",arguments);this.addBodyPassthroughMethods()}
...
,isc.A.getAvailableFields=function isc_FormulaBuilder_getAvailableFields(){if(!this.availableFields)
this.availableFields=this.getClass().getAvailableFields(this.getFields(),this.field);return this.availableFields}
...
);isc.B._maxIndex=isc.C+34;isc.A=isc.FormulaBuilder;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.mappingKeyForIndex=function isc_c_FormulaBuilder_mappingKeyForIndex(_1){var _2="",_3=Math.floor(_1/ 26);for(var i=0;i<_3;i++)_2+="A";_2+=String.fromCharCode(65+_1%26);return _2}
,isc.A.getFieldIdProperty=function isc_c_FormulaBuilder_getFieldIdProperty(_1){return _1?_1.fieldIdProperty:"name"}
,isc.A.getAvailableFields=function isc_c_FormulaBuilder_getAvailableFields(_1,_2){var _3=[],j=0;if(!_1)return _3;_1=_1.sortByProperty("name",true);for(var i=0;i<_1.getLength();i++){var _6=_1.get(i),_7=_6.type;if(_6.name==_2.name)continue;if(_6.userFormula||isc.SimpleType.inheritsFrom(_7,"integer")||isc.SimpleType.inheritsFrom(_7,"float"))
...
_3=_3.sortByProperties(["mappingKey"],[true],[function(_6,_13,_14){return _6[_13].length==1?' '+_6[_13]:_6[_13]}]);return _3}
,isc.A.getUsedFields=function isc_c_FormulaBuilder_getUsedFields(_1,_2,_3){var _4=this.getAvailableFields(_2,_3),_5=[];if(!_4||!_1)return _5;_4=_4.sortByProperties(["mappingKey"],[false],[function(_7,_8,_9){return _7[_8].length==1?' '+_7[_8]:_7[_8]}]);for(var i=0;i<_4.length;i++){var _7=_4.get(i);if(this.allowEscapedKeys){if(_1.indexOf("#"+_7.mappingKey)>=0||_1.indexOf("#{"+_7.mappingKey+"}")>=0)
...
return _1.toString()}
,isc.A.getAvailableFields=function isc_SummaryBuilder_getAvailableFields(){if(!this.availableFields)
this.availableFields=this.getClass().getAvailableFields(this.getFields(),this.field);return this.availableFields}
...
_3=_3.sortByProperties(["mappingKey"],[true],[function(_6,_12,_13){return _6[_12].length==1?' '+_6[_12]:_6[_12]}]);return _3}
,isc.A.getUsedFields=function isc_c_SummaryBuilder_getUsedFields(_1,_2,_3,_4){var _5=this.getAvailableFields(_2,_4),_6=[];if(!_5||!_1)return _6;_5=_5.sortByProperties(["mappingKey"],[false],[function(_8,_9,_10){return _8[_9].length==1?' '+_8[_9]:_8[_9]}]);for(var i=0;i<_5.length;i++){var _8=_5.get(i);if(_1.indexOf("#{"+_8.mappingKey+"}")>=0)
...
return _5}
,isc.A.generateFunction=function isc_c_SummaryBuilder_generateFunction(_1,_2,_3){var _4=isc.SB.create(),_5=_1.text,_6=this.getFieldIdProperty(_3),_7=this.getFieldDetailsFromValue(_1.summaryVars,_2,_3),_8=_7.usedFields,_9=_7.missingFields;_8=_8.sortByProperties(["mappingKey"],[false],[function(_11,_14,_15){return _11[_14].length==1?' '+_11[_14]:_11[_14]}]);if(_8.length>0){_4.append("var ");for(var i=0;i<_8.length;i++){var _11=_8.get(i);if(i>0)_4.append("        ");_4.append(_11.mappingKey,"=(component ? component.getStandaloneFieldValue(record,'",_11[_6],"') : record['",_11[_6],"']");_4.append(i==_8.length-1?");":"),","\n");_5=_5.replaceAll("#{"+_11.mappingKey+"}","'+"+_11.mappingKey+"+'");_5=_5.replaceAll("#"+_11.mappingKey,"'+"+_11.mappingKey+"+'")}
_4.append("\n")}
